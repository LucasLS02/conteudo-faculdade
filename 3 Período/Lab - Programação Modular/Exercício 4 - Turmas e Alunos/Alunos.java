...
public class Alunos {
	...
	private void init(String nome,int valorProvas, int faltas) {
		this.nome = nome;
		this.avaliacoes = iniciarProvas(valorProvas,4);
		this.codTurma = "";
		this.faltas = faltas;
		aprovado = false;
	...
	Alunos(String nome,int valorProvas, int faltas) {
		init(nome,valorProvas, faltas);
	}
	...
	private Provas[] iniciarProvas(int valorProva,int quantidadeProvas)
	{
