...
public class testTurmas {
	...
	void init() {
		turma1 = new Turmas();
		turma2 = new Turmas(2, "terca-feira", "noite", 2);
	}
	...
	void objetoInicializadoPadrao() {
		...
		assertEquals(0, turma1.getAulasRealizadas());
	}
	...
	void objetoInicializadoParametros() {
		...
		assertEquals(2, turma2.getAulasRealizadas());
	}
	...
	void realizarAula() {
		turma1.realizarAula();
		assertEquals(1, turma1.getAulasRealizadas());
	}
	
	@Test
	void realizarAulaAcima20() {
		for(int i = 0;i<21;i++) {
			turma1.realizarAula();
		}
		assertEquals(20, turma1.getAulasRealizadas());
	}
